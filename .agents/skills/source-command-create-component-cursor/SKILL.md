---
name: "source-command-create-component-cursor"
...
# source-command-create-component-cursor

Use this skill when the user asks to run the migrated source command `create-component-cursor`.
...
> The original at `.Codex/commands/create-component.md` is the Codex version (uses `AskUserQuestion`).
...
- Use the Read tool to view it (Codex is multimodal)
