...
**Requires**: `reply-quote`, `button`, `tooltip`, `dialog`, `doc-media`, `dropdown-menu`, `spinner`, `sender-indicator`, `chat-types`, `chat-timeline-divider`, `chat-provider` (auto-installed)
**Type**: Multi-file component
