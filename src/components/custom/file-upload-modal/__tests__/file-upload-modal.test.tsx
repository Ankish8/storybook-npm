...
describe("FileUploadModal", () => {
  it("renders title and buttons when open", () => {
    render(
      <FileUploadModal open={true} onOpenChange={vi.fn()} />
    );
  ...
  it("hides sample download link when not provided", () => {
    ...
    expect(
      screen.queryByText("Download sample file")
  ...
  it("does not render when closed", () => {
    render(
      <FileUploadModal open={false} onOpenChange={vi.fn()} />
    );
  ...
  it("applies custom className", () => {
    ...
    // The className is applied to DialogContent which is the ref target
