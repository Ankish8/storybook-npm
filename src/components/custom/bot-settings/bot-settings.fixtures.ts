...
export const demoWhatsappOptions: MultiSelectOptionAuthoring[] = [
  {
    value: "wa-1",
    label: "+91 9876543210",
    caption: "Assigned to Bot Name 1",
  },
  {
    value: "wa-2",
    label: "+91 6543120931",
 ...
 */
export const whatsappGroupedSections: readonly MultiSelectGroupedSection<MultiSelectOptionAuthoring>[] =
  [
    {
    ...
    },
    {
      ...
      options: [{ value: "g5", label: "+91 7653443219" }],
    },
  ];
