...
<table style="width: 100%; border-collapse: collapse; font-size: 14px; margin-top: 16px;">
  ...
  <tbody>
    ...
    <tr style="border-bottom: 1px solid #E9EAEB;">
      ...
      <td style="padding: 12px 16px;"><code style="background: #F5F5F5; padding: 2px 6px; border-radius: 4px; font-size: 12px;">--radius-md</code></td>
      <td style="padding: 12px 16px; font-family: monospace; font-size: 13px;">6px</td>
    ...
    <tr style="border-bottom: 1px solid #E9EAEB;">
      ...
      <td style="padding: 12px 16px; font-family: monospace; font-size: 13px;">6px 12px</td>
      <td style="padding: 12px 16px;">—</td>
    </tr>
  </tbody>
</table>
