...
describe('SelectField', () => {
  ...
  it('renders placeholder text', () => {
    render(<SelectField options={defaultOptions} placeholder="Select an option" />)
  ...
  it('associates label with select via htmlFor', () => {
    render(<SelectField label="Test Label" options={defaultOptions} id="test-select" />)
  ...
  it('shows spinner when loading', () => {
    const { container } = render(<SelectField options={defaultOptions} loading />)
  ...
  it('applies custom triggerClassName', () => {
    render(<SelectField options={defaultOptions} triggerClassName="custom-trigger" />)
