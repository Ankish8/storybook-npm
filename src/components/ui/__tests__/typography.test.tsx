...
import { Typography, mapTagName, mapClassName, mapColorClassName, mapAlignClassName } from '../typography'
...
describe('Typography', () => {
  ...
  describe('HTML Tag Mapping', () => {
    ...
    it.each(tagTestCases)(
      ...
      (kind, variant, expectedTag) => {
        ...
        expect(screen.getByTestId('typography').tagName.toLowerCase()).toBe(expectedTag)
      }
    )
  })
  ...
  describe('Custom Tag Override', () => {
    it('overrides default tag with custom tag', () => {
      render(
        <Typography kind="body" variant="medium" tag="p" data-testid="typography">
          Paragraph text
        </Typography>
      )
    ...
    it('can render as div', () => {
      ...
      expect(screen.getByTestId('typography').tagName.toLowerCase()).toBe('div')
    })
    ...
    it('can render as strong', () => {
      ...
      expect(screen.getByTestId('typography').tagName.toLowerCase()).toBe('strong')
    })
  })
  ...
  describe('Label htmlFor', () => {
    it('applies htmlFor attribute on label elements', () => {
      render(
        <Typography kind="label" variant="medium" htmlFor="email-input" data-testid="typography">
          Email
        </Typography>
      )
      expect(screen.getByTestId('typography')).toHaveAttribute('for', 'email-input')
    })
    ...
    it('applies htmlFor when tag is overridden to label', () => {
      ...
      expect(screen.getByTestId('typography')).toHaveAttribute('for', 'custom-input')
    })
  })
  ...
  describe('ClassName Merging', () => {
    it('merges custom className with default classes', () => {
      render(
        <Typography className="custom-class another-class" data-testid="typography">
          Test
        </Typography>
      )
      const element = screen.getByTestId('typography')
  ...
  describe('Prop Spreading', () => {
    it('spreads id prop', () => {
      ...
      expect(screen.getByTestId('typography')).toHaveAttribute('id', 'unique-id')
    })
    ...
    it('spreads title prop', () => {
      ...
      expect(screen.getByTestId('typography')).toHaveAttribute('title', 'Tooltip text')
    })
    ...
    it('spreads data-* attributes', () => {
      ...
      expect(screen.getByTestId('typography')).toHaveAttribute('data-custom', 'value')
    })
    ...
    it('spreads aria-* attributes', () => {
      ...
      expect(screen.getByTestId('typography')).toHaveAttribute('aria-label', 'Accessible text')
    })
  })
