...
- **Custom Tags**: Override default semantic tags when needed
  ...
  argTypes: {
    ...
    kind: {
      ...
      description:
        "Typography kind - determines base styling and semantic HTML tag",
      table: {
        type: {
          summary: '"display" | "headline" | "title" | "label" | "body"',
        },
    ...
    color: {
      ...
      table: {
        type: {
          summary:
            '"primary" | "secondary" | "muted" | "placeholder" | "link" | "inverted" | "error" | "success"',
        },
    ...
    truncate: {
      control: "boolean",
      description:
        "Enable text truncation with ellipsis (requires block display)",
      table: {
    ...
    htmlFor: {
      control: "text",
      description:
        "Associates label with a form element (only works with label tag)",
      table: {
        type: { summary: "string" },
        defaultValue: { summary: "undefined" },
        category: "Advanced",
...
export const Overview: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Interactive playground to explore all Typography props. Try changing the controls below.",
      },
    },
  },
  decorators: [
  ...
  render: () => (
    <div className="flex flex-col gap-6 max-w-2xl">
      <div>
        ...
        <Typography kind="display" variant="medium">
          Display Text
        </Typography>
      </div>
      <div>
        ...
        <Typography kind="headline" variant="medium">
          Headline Text
        </Typography>
      </div>
      <div>
        ...
        <Typography kind="title" variant="medium">
          Title Text
        </Typography>
      </div>
      <div>
        ...
        <Typography kind="label" variant="medium">
          Label Text
        </Typography>
      </div>
      <div>
        ...
        <Typography kind="body" variant="medium">
          Body Text
        </Typography>
      </div>
    </div>
...
export const AllVariants: Story = {
  ...
  render: () => (
    <div className="flex flex-col gap-8 max-w-2xl">
      <div>
        <Typography kind="title" variant="small" color="muted" className="mb-4">
          Headlines
        </Typography>
        <div className="flex flex-col gap-2">
          <Typography kind="headline" variant="large">
            Headline Large (32px)
          </Typography>
          <Typography kind="headline" variant="medium">
            Headline Medium (28px)
          </Typography>
          <Typography kind="headline" variant="small">
            Headline Small (24px)
          </Typography>
        </div>
      </div>
      <div>
        ...
        <div className="flex flex-col gap-2">
          <Typography kind="title" variant="large">
            Title Large (18px)
          </Typography>
          <Typography kind="title" variant="medium">
            Title Medium (16px)
          </Typography>
          <Typography kind="title" variant="small">
            Title Small (14px)
          </Typography>
        </div>
      </div>
      <div>
        ...
        <div className="flex flex-col gap-2">
          <Typography kind="body" variant="large">
            Body Large (16px)
          </Typography>
          <Typography kind="body" variant="medium">
            Body Medium (14px)
          </Typography>
          <Typography kind="body" variant="small">
            Body Small (12px)
          </Typography>
        </div>
      </div>
      <div>
        ...
        <div className="flex flex-col gap-2">
          <Typography kind="label" variant="large">
            Label Large (14px)
          </Typography>
          <Typography kind="label" variant="medium">
            Label Medium (12px)
          </Typography>
          <Typography kind="label" variant="small">
            Label Small (10px)
          </Typography>
        </div>
      </div>
  ...
  render: () => (
    <div className="flex flex-col gap-4">
      <div className="flex items-center gap-4">
        <div className="w-24">
          <Typography kind="label" variant="small" color="muted">
            Primary
          </Typography>
        </div>
        <Typography color="primary">
          Primary text for main content (#181D27)
        </Typography>
      </div>
      <div className="flex items-center gap-4">
        <div className="w-24">
        ...
        <Typography color="secondary">
          Secondary text for supporting content (#343E55)
        </Typography>
      </div>
      <div className="flex items-center gap-4">
        <div className="w-24">
        ...
        <Typography color="muted">
          Muted text for captions and helper text (#717680)
        </Typography>
      </div>
      <div className="flex items-center gap-4">
        <div className="w-24">
        ...
        <Typography color="placeholder">
          Placeholder text for inputs (#A2A6B1)
        </Typography>
      </div>
      <div className="flex items-center gap-4">
        <div className="w-24">
        ...
        <Typography color="link">
          Link text for clickable elements (#4275D6)
        </Typography>
      </div>
      <div className="flex items-center gap-4 bg-[#343E55] p-3 rounded">
        <div className="w-24">
          <Typography kind="label" variant="small" color="inverted">
            Inverted
          </Typography>
        </div>
        <Typography color="inverted">
          Inverted text on dark backgrounds (#FFFFFF)
        </Typography>
      </div>
      <div className="flex items-center gap-4">
        <div className="w-24">
        ...
        <Typography color="error">
          Error text for validation messages (#F04438)
        </Typography>
      </div>
      <div className="flex items-center gap-4">
        <div className="w-24">
        ...
        <Typography color="success">
          Success text for confirmation messages (#17B26A)
        </Typography>
      </div>
    </div>
  ),
...
export const SemanticTags: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Typography automatically uses semantic HTML tags based on the kind and variant.",
      },
    },
  },
  render: () => (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="w-20">
          <code className="text-xs bg-gray-100 px-1.5 py-0.5 rounded">h1</code>
        </div>
        <Typography kind="headline" variant="large">
          Page Title
        </Typography>
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="w-20">
          <code className="text-xs bg-gray-100 px-1.5 py-0.5 rounded">h2</code>
        </div>
        <Typography kind="headline" variant="medium">
          Section
        </Typography>
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="w-20">
          <code className="text-xs bg-gray-100 px-1.5 py-0.5 rounded">h3</code>
        </div>
        <Typography kind="headline" variant="small">
          Subsection
        </Typography>
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="w-20">
          <code className="text-xs bg-gray-100 px-1.5 py-0.5 rounded">h5</code>
        </div>
        <Typography kind="title" variant="medium">
          Card Title
        </Typography>
  ...
  render: () => (
    <div className="flex flex-col gap-8 max-w-lg">
      ...
      <div className="border border-gray-200 rounded-lg p-6">
        <Typography kind="label" variant="small" color="muted" className="mb-4">
          Page Header
        </Typography>
        <Typography kind="headline" variant="large" className="mb-2">
          Dashboard
        </Typography>
      ...
      <div className="border border-gray-200 rounded-lg p-6">
        ...
        <div className="border border-gray-200 rounded-lg p-4">
          <Typography kind="title" variant="medium" className="mb-2">
            Project Overview
          </Typography>
...
export const DisplayShowcase: Story = {
  ...
  render: () => (
    <div className="flex flex-col gap-4">
      <Typography kind="display" variant="large">
        Display Large
      </Typography>
      <Typography kind="display" variant="medium">
        Display Medium
      </Typography>
      <Typography kind="display" variant="small">
        Display Small
      </Typography>
    </div>
  ),
