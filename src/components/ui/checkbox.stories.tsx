...
<table style="width: 100%; border-collapse: collapse; font-size: 14px; margin-top: 16px;">
  ...
  <tbody>
    ...
    <tr style="border-bottom: 1px solid #E9EAEB;">
      <td style="padding: 12px 16px;">Hover Border</td>
      <td style="padding: 12px 16px;"><code style="background: #F5F5F5; padding: 2px 6px; border-radius: 4px; font-size: 12px;">--semantic-border-secondary</code></td>
      <td style="padding: 12px 16px; font-family: monospace; font-size: 13px !important;">777E8D</td>
      <td style="padding: 12px 16px;"><div style="width: 32px; height: 32px; background-color: #777E8D; border-radius: 6px; border: 1px solid #E9EAEB;"></div></td>
    </tr>
    <tr style="border-bottom: 1px solid #E9EAEB;">
...
const SelectAllExample = () => {
  ...
  const selectAllState: CheckedState = allChecked
    ? true
    : someChecked
      ? "indeterminate"
      : false;
...
export const SelectAllPattern: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Demonstrates the indeterminate state for "select all" functionality. The parent checkbox shows indeterminate when some (but not all) children are selected.',
      },
    },
  },
};
  ...
  return (
    <div className="flex flex-col gap-4">
      <p className="text-sm text-gray-600 mb-2">
        Using <code className="bg-gray-100 px-1 rounded">separateLabel</code>{" "}
        mode with htmlFor/id association:
      </p>
      <Checkbox
        id="terms-checkbox"
      ...
      <p className="text-xs text-gray-500">
        Click the label text - it will toggle the checkbox via htmlFor
        association.
      </p>
    </div>
  );
...
export const AccessibilityExample: Story = {
  ...
  render: () => (
    <div className="flex flex-col gap-6">
      ...
      <div>
        <p className="text-sm text-gray-600 mb-2">
          Using aria-labelledby prop:
        </p>
        <div className="flex items-center gap-2">
          <span id="notification-label" className="text-sm">
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Use `aria-label` prop when you need to provide a custom accessible name. Use `aria-labelledby` prop when the checkbox is described by external elements.",
      },
    },
  },
};
...
export const CustomStyling: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Use `checkboxClassName` to style the checkbox element and `labelClassName` to style the label text.",
      },
    },
  },
};
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <Checkbox
        ...
        onCheckedChange={(v) =>
          setFormData((prev) => ({ ...prev, newsletter: v === true }))
        }
      />
      <Checkbox
        name="preferences"
        ...
        onCheckedChange={(v) =>
          setFormData((prev) => ({ ...prev, updates: v === true }))
        }
      />
      <Checkbox
        name="preferences"
        ...
        onCheckedChange={(v) =>
          setFormData((prev) => ({ ...prev, marketing: v === true }))
        }
      />
...
export const FormIntegration: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "The `name` and `value` props store form metadata on the element for custom form handling. Since this is a button-based checkbox, these are stored as data attributes rather than native form properties.",
      },
    },
  },
};
